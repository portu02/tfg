...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-04-2023 a las 20:41:54
...
CREATE TABLE `butaca` (
  ...
  `color` enum('Verde','Rojo','Gris') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pelicula` (
  ...
  `sinopsis` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `duracion` smallint NOT NULL,
  `url` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `clasificacion` enum('TP','+7','+12','+16','+18') COLLATE utf8mb4_general_ci NOT NULL,
  `categoria` enum('Acción','Aventuras','Ciencia Ficción','Comedia','No-Ficción','Drama','Documental','Fantasía','Musical','Suspense','Terror','Thriller','Animación','Infantil') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(14, 'La memoria de un asesino', 'memory.jpg', 'Alex, un sicario, se convierte en el objetivo de su organización por negarse a cumplir un trabajo. Mientras huye de ellos, el FBI y el servicio de inteligencia mexicano siguen sus pasos, alertados por el reguero de cadáveres que deja por donde va.', 114, NULL, 'TP', 'Acción'),
(15, 'Black Adam', 'Black_Adam.jpg', 'Unos arqueólogos liberan de su tumba a Black Adam, quien llevaba 5000 años preso tras haber recibido los poderes de los dioses. De nuevo entre los humanos, Black Adam se dispone a imponer su justicia, muy diferente a la del mundo en el que despertó.', 125, NULL, 'TP', 'Acción'),
(16, 'El proyecto Adam', 'El_proyecto_Adam.jpg', 'Adam Reed, un viajero del tiempo y piloto de combate, aterriza en el año 2022. Allí, se encuentra con su yo de doce años y, junto a él, tratará de salvar el futuro.', 106, NULL, 'TP', 'Acción'),
(17, 'El visitante del futuro', 'El_visitante_del_futuro.jpg', 'Alice es una joven que se opone a la construcción de una central nuclear iniciada por su padre, que es diputado. Es entonces cuando un extraño visitante los traslada al año 2555, un futuro devastado por la explosión de la central.', 102, NULL, 'TP', 'Acción'),
(18, 'Spider-Man: No Way Home', 'Spider-Man.jpg', 'Esta versión extendida cuenta con más de 11 minutos contenido extra, incluyendo escenas eliminadas.Por primera vez en la historia cinematográfica de Spider-Man, nuestro héroe, vecino y amigo es desenmascarado y por tanto ya no es capaz de separar su vida normal de los enormes riesgos que conlleva ser un Súper Héroe. Cuando pide ayuda a Doctor Strange, los riesgos pasan a ser aún más peligrosos, obligándole a descubrir lo que realmente significa ser Spider-Man.', 148, NULL, 'TP', 'Acción'),
(19, 'Encanto', 'Encanto.jpg', 'En lo alto de las montañas de Colombia hay un lugar encantado llamado Encanto. Aquí, en una casa mágica, vive la extraordinaria familia Madrigal donde todos tienen habilidades fantásticas.', 109, NULL, 'TP', 'Acción'),
(20, 'Hasta el cielo', 'Hasta_el_cielo.jpg', 'Un thriller con trasfondo social, que narra las peripecias de una banda de chavales delincuentes tras las grúas de la burbuja inmobiliaria.', 122, NULL, 'TP', 'Acción');
...
CREATE TABLE `sala` (
  ...
  `imagen` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `usuario` (
  ...
  `apellido1` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido2` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_usuario` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `correo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `contrasena` char(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rol` char(13) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `butaca`
  MODIFY `id_butaca` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pelicula`
--
ALTER TABLE `pelicula`
  MODIFY `id_pelicula` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `sala`
--
ALTER TABLE `sala`
  MODIFY `id_sala` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
