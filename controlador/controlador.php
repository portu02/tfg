...
} elseif (isset($_GET["pagina_pelicula"]) || isset($_POST["pelicula_admin"]) || isset($_POST["borrar_peli"]) || isset($_POST["nueva_pelicula"]) || isset($_POST["editar_pelicula"])|| isset($_POST["enviar_pelicula"])){
...
elseif (isset($_GET["pagina_usuario"]) || isset($_POST["usuario_admin"])  || isset($_POST["borrar_usuario_admin"])  || isset($_POST["editar_usuario_admin"]) || isset($_POST["cambiar_usuario_admin"])) {
